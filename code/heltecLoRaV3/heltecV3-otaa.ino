...
/* OTAA para*/
uint8_t devEui[] = { 0x00, 0xB3, 0x00, 0x7E, 0x00, 0x00, 0xDB, 0x08 };
uint8_t appEui[] = { 0xAA, 0xBB, 0x00, 0xBB, 0xAA, 0x00, 0x00, 0xBB };
uint8_t appKey[] = { 0xC0, 0x00, 0x00, 0xF8, 0x40, 0x00, 0x10, 0xA2, 0x00, 0x0E, 0x41, 0x00, 0x6F, 0x34, 0x3F, 0xA8 };
